...
expected_outputs=(
  ./beef/Beef.bo
  ./beef/beef.ba
  ./beef/vpi_wrapper_beef.c
  ./beef/vpi_wrapper_beef.h
)
BSC \
  -verilog \
  $(path_dir_flags ./beef) \
...
expected_outputs=(
  ./cafe/Cafe.bo
  ./cafe/cafe.ba
  ./cafe/vpi_wrapper_cafe.c
  ./cafe/vpi_wrapper_cafe.h
)
BSC \
  -verilog \
  $(path_dir_flags ./cafe) \
...
expected_outputs=(
  ./test/BeefCafeTest.bo
  ./test/mkBeefCafeTest.v
)
BSC \
  -verilog \
  $(path_dir_flags ./test) \
...
implicit_files=(
  ./test/BeefCafeTest.bo
  ./test/vpi_wrapper_{beef,cafe}.{c,h}
)
expected_outputs=(
  ./test/BeefCafeTest.exe
  ./directc_mkBeefCafeTest.so
)
extra_outputs=(
  ./beef/beef.o
  ./cafe/cafe.o
  ./test/vpi_startup_array.{c,o}
  ./test/vpi_wrapper_{beef,cafe}.o
)
BSC \
  -verilog \
  $(path_dir_flags ./test) \
  -o ./test/BeefCafeTest.exe \
  -e mkBeefCafeTest \
  ${source_files[@]}
